...
void test_main(size_t init_capacity = 64 * 1024 * 1024UL,
  ...
  cout << "real load_factor = " << table->load_factor(stream) << endl;
...
//    cout << endl;
    ...
    print_title();
    test_main<64>(128 * 1024 * 1024UL, 1024 * 1024UL, 0, 0.50);
    test_main<64>(128 * 1024 * 1024UL, 1024 * 1024UL, 0, 0.75);
    test_main<64>(128 * 1024 * 1024UL, 1024 * 1024UL, 0, 1.00);

//    test_main<64>(1024 * 1024 * 1024UL, 1024 * 1024UL, 0, 0.50);
//    test_main<64>(1024 * 1024 * 1024UL, 1024 * 1024UL, 0, 0.75);
//    test_main<64>(1024 * 1024 * 1024UL, 1024 * 1024UL, 0, 1.00);

    test_main<128>(64 * 1024 * 1024UL, 1024 * 1024UL, 0, 0.50);
    test_main<128>(64 * 1024 * 1024UL, 1024 * 1024UL, 0, 0.75);
    test_main<128>(64 * 1024 * 1024UL, 1024 * 1024UL, 0, 1.00);

    test_main<128>(512 * 1024 * 1024UL, 1024 * 1024UL, 0, 0.50);
    test_main<128>(512 * 1024 * 1024UL, 1024 * 1024UL, 0, 0.75);
    test_main<128>(512 * 1024 * 1024UL, 1024 * 1024UL, 0, 1.00);
    cout << endl;
