...
Status MerlinKVShape(InferenceContext* c, const ShapeHandle& key,
...
REGISTER_OP("MerlinKVFindWithMetas")
    .Input("table_handle: resource")
    .Input("keys: Tin")
    .Input("default_value: Tout")
    .Output("values: Tout")
...
REGISTER_OP("MerlinKVFindWithExists")
    .Input("table_handle: resource")
    .Input("keys: Tin")
    .Input("default_value: Tout")
    .Output("values: Tout")
...
REGISTER_OP("MerlinKVInsertWithMetas")
    .Input("table_handle: resource")
    .Input("keys: Tin")
    .Input("values: Tout")
    .Input("metas: int64")
...
REGISTER_OP("MerlinKVClear")
    .Input("table_handle: resource")
    .Attr("key_dtype: type")
    .Attr("value_dtype: type");

REGISTER_OP("MerlinKVSize")
    .Input("table_handle: resource")
    .Output("size: int64")
    .SetShapeFn(ScalarAndTwoElementVectorInputsAndScalarOutputs);

REGISTER_OP("MerlinKVExport")
    .Input("table_handle: resource")
    .Output("keys: Tkeys")
...
REGISTER_OP("MerlinKVOfTensors")
    ...
    .SetShapeFn([](InferenceContext* c) {
      ...
      return MerlinKVShape(c, /*key=*/c->Scalar(), /*value=*/value_s);
    });
}  // namespace tensorflow
